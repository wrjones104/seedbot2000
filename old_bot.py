...
async def on_message(message):
    ...
    if message.guild.id in suppressed_servers:
        ...
        if message.content.startswith('!oldrando'):
        ...
        if message.content.startswith('!oldchaos'):
            stype = flags.chaos()
            mtype = "chaos"
            seedmsg = "Here's your chaos seed. Have fun!"
        ...
        if message.content.startswith('!oldtruechaos') or message.content.startswith('!oldtrue_chaos'):
            stype = flags.true_chaos()
            mtype = "true chaos"
            seedmsg = "Here's your true chaos seed. Have fun!"
        ...
        if message.content.startswith('!oldhardchaos'):
            if '-s' in args:
                paint = spraypaint()
                ptype = True
            else:
        ...
        if message.content.startswith('!oldeasychaos'):
            if '-s' in args:
                paint = spraypaint()
                ptype = True
            else:
        ...
        if message.content.startswith('!oldcr') or message.content.startswith('!oldrated'):
            try:
