...
async def on_message(message):
    ...
    error_msgs = ["Bzzzt!", "Beep!", "Boop!", "RRrrrrrrrRRR!", "Dammit Jones!", "Vzzzzzt!"]
    ...
    if message.content.startswith("!rated"):
        ...
        #     errmsg = ' '.join([random.choice(error_msgs), repr(e), str(b)])
        #     await message.channel.send(errmsg)

    # if message.content.startswith("!test"):
    #     print(flags.RandomSeed())
    #     this_flag = random.choice(list(flags.flag_list))
    #     print(this_flag)
    #     # Select the modified value
    #     new_value = random.choice(flags.flag_list[this_flag])
    #     print(new_value)
    #     # await message.channel.send(DefaultSeed())
